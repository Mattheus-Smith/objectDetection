...
img = cv2.imread("./roi/roi_jogador5.png")
...
bar = plot_colors(hist, clt.cluster_centers_, arrayColors,array_por_Colors)
...
saida = detectionJogador(arrayColors, array_por_Colors)
print(saida)
#findOrange(arrayColors)
